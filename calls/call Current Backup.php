...
// Define profile picture base path
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cl-header-title {
            ...
            justify-content: center;
            text-align: center;
            /* Offset to account for hamburger width so title appears truly centered */
            margin-left: -48px; /* Compensate for hamburger + margin */
        }

        /* Empty right spacer for balance */
        .cl-header-spacer {
            flex-shrink: 0;
            width: 48px; /* Same width as hamburger area */
            display: flex;
            align-items: center;
            justify-content: center;
        }
    ...
    <div class="cl-wrapper">
        <div class="cl-header">
            ...
            <div class="cl-header-title">
                Calls <span class="cl-pro-badge">PRO</span>
            </div>
        ...
        <div class="cl-contacts-list" id="clContactsList">
            <?php if ($result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    ...
                    $profile_pic_url = !empty($row['profile_photo']) ? $profile_pic_base . $row['profile_photo'] : '';
                    $display_name = $row['fullname'] ?? $row['username'];
                    ...
                    <div class="cl-contact-item contact-item" 
                        ...
                        data-user-picture="<?= htmlspecialchars($profile_pic_url) ?>"
                        onclick="clOpenModal(this)">
                        <div class="cl-avatar">
                            <?php if (!empty($profile_pic_url)): ?>
                                <img src="<?= htmlspecialchars($profile_pic_url) ?>" 
                        ...
                        <div class="cl-contact-info">
                            <div class="cl-contact-name"><?= htmlspecialchars($display_name) ?></div>
